...
class CIFAR10(VisionDataset):
        ...
        if base_sess:
            ...
            if train:
                if self.few_shot is False:
                    ...
                    data_index = self.get_random_tasks_index(self.targets, index)
    ...
    def get_random_tasks_index(self, targets, index):
    ...
    def get_examples(self, high_idx):
        examples = []
        for cls_idx in range(high_idx):
            img = self.data[self.targets == cls_idx][0]
